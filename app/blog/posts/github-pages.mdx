...
summary: "Um guia prático de como montei meu blog pessoal usando Next.js e hospedei de graça no GitHub Pages"
thumbnail: "/thumbnails/github-pages-blog.jpg"
tags: [Next.js, GitHub Pages, Tutorial, Web Development]
---
...
├── .github/
│   └── workflows/
│       └── nextjs.yml          # Workflow de deploy
├── app/
│   ├── blog/
│   │   ├── [slug]/
│   │   │   └── page.tsx        # Página individual de cada post
│   │   ├── posts/
│   │   │   ├── hello-world.mdx
│   │   │   └── github-pages.mdx
│   │   └── page.tsx            # Listagem de todos os posts
│   ├── contact/
│   │   └── page.tsx            # Página de contato
│   ├── components/
│   │   ├── comments.tsx        # Componente do Giscus
│   │   ├── footer.tsx
│   │   └── header.tsx
...
![imagem](https://raw.githubusercontent.com/OrlandoBitencourt/orlandobitencourt.github.io/refs/heads/main/public/posts/2025-11-17-github-pages/config.png)
