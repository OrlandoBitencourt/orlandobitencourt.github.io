...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center gap-2 py-6 text-neutral-500 text-sm">
      <ul className="font-sm mt-8 flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 text-neutral-600 dark:text-neutral-300">
        <li>
          <a
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://www.linkedin.com/in/orlando-bitencourt/"
          >
            <ArrowIcon />
